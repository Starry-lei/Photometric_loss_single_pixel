		...
		void Init(){
			...
			if(options_.isTextured){
				...
				if (options_.baseline==0){
					// TODO: change the data(/255) and depth
					 image_ref_path = "../Env_Light_Data/NonLambertian_Data/ref_camera/image_ref_RGB.png";
					 image_ref_baseColor_path = "../Env_Light_Data/NonLambertian_Data/ref_camera/image_BaseColor.png";
					 depth_ref_path = "../Env_Light_Data/NonLambertian_Data/ref_camera/image_saveDepth.hdr";
					 image_ref_metallic=  0.95;
					 image_ref_roughness= 0.68;

				}
				Eigen::Quaterniond q_1( 0.0529 ,  -0.0412  , -0.6133   , 0.7870); //  cam1  wxyz
				Eigen::Vector3d t1(-0.389256 , -2.882950, 0.732858);
				R1 = q_1.toRotationMatrix();
				cout<<"show input R1:\n"<<R1<<endl;

				//normal map GT
				string normal_GT_path="../Env_Light_Data/NonLambertian_Data/ref_camera/image_normal_GT.png";
...
//				setGlobalCalib(cols,rows,camera_intrinsics);
				...
				if (options_.baseline==0){
					image_target_path ="../Env_Light_Data/NonLambertian_Data/tar_camera/image_tar_RGB.png";
					image_target_baseColor_path = "../Env_Light_Data/NonLambertian_Data/tar_camera/image_BaseColor.png";
					depth_target_path = "../Env_Light_Data/NonLambertian_Data/tar_camera/image_Depth.hdr";

					Eigen::Quaterniond q_2( 0.0045  , -0.0035 ,   0.6071 ,  -0.7946); //  cam2  wxyz
					Eigen::Vector3d t2(0.033104 , -2.894269 ,0.788738);
