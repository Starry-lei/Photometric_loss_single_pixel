...
namespace gsn {
  ...
  */
  ...
  class ShaderNode : protected QOpenGLExtraFunctions {
  public:
  ...
  private:
    ...
    std::string findAttributeInComments(const std::string& line, const std::string& attr) const;
    int strToBendFunc(const std::string& inputStr) const;
    bool beforeGLSLversion1_2(const std::string &code) const;
  };
}
#endif
